...
Mark the stop line where the bag comes under the limit, say where each item physically is (bag
and cube), and keep the list to roughly what is needed plus 30%.
